...
"""autogenerated by genpy from ecam_msg/Encoders.msg. Do not edit."""
import sys
...
class Encoders(genpy.Message):
  _md5sum = "189368fd89d1fdc2727ab57efab8cd75"
  _type = "ecam_msg/Encoders"
...
int64 rear_right"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4q().pack(_x.front_left, _x.front_right, _x.rear_left, _x.rear_right))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.front_left, _x.front_right, _x.rear_left, _x.rear_right,) = _get_struct_4q().unpack(str[start:end])
      return self
